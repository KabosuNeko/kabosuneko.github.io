...
- `assets/js/app.js` - shared logic (theme, clock, Nadeshiko click-react)
...
2. Push - the gallery auto-scans the folder via the GitHub API and falls back to the hardcoded list in `assets/js/gallery.js`.
